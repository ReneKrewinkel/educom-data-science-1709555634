...
df_table1.to_sql('country', engine, if_exists='replace', index=False)
df_table2.to_sql('population', engine, if_exists='replace', index=False)
df_table3.to_sql('statistics', engine, if_exists='replace', index=False)